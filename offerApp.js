...
function initializeIntlTelInput(inputElement) {
  ...
  form.addEventListener("submit", (event) => {
    ...
    let phoneInput = form.querySelector('input[name="all_phn"]');
...
const inputs = document.querySelectorAll("input[name=all_phn]");
...
$('input[name="all_phn"]').on("input", function () {
...
$('input[name="all_phn"]').on("keyup", function () {
...
function initForm() {
  let inputs = document.querySelectorAll("input[name=all_phn]");
